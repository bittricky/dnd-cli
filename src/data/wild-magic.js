// Standard PHB Wild Magic Surge Table
export const PHB_SURGE_TABLE = [
	{
		range: [1, 2],
	...
	{ range: [13, 14], effect: 'You cast Confusion centered on yourself.' },
	{
		range: [15, 16],
	...
	{
		range: [31, 32],
		effect: 'You are transported to the Astral Plane until the end of your next turn, after which time you return to the space you previously occupied.'
	},
	{
		range: [33, 34],
	...
	{
		range: [37, 38],
		effect: '1d6 flumphs controlled by the DM appear in unoccupied spaces within 60 feet of you and are frightened of you. They vanish after 1 minute.'
	},
	{ range: [39, 40], effect: 'You regain 2d10 hit points.' },
	{
		range: [41, 42],
	...
	{
		range: [89, 90],
		effect: "You become invisible for the next minute. During that time, other creatures can't hear your voice."
	},
	{
		range: [91, 92],
	...
	{
		range: [93, 94],
		effect: 'Your size increases by one category for the next minute.'
	},
	{
		range: [95, 96],
	...
	{ range: [99, 100], effect: 'You regain all expended sorcery points.' }
];

// Tasha's Cauldron of Everything - Additional Wild Magic Options
export const TASHAS_SURGE_TABLE = [
	{
		range: [1, 2],
		effect: 'You cast Chaos Bolt as a 1st-level spell without expending a spell slot.'
	},
	{ range: [3, 4], effect: 'You cast Bane without expending a spell slot.' },
	{
		range: [5, 6],
		effect: 'You cast Color Spray without expending a spell slot.'
	},
	{
		range: [7, 8],
		effect: 'You cast Hideous Laughter without expending a spell slot.'
	},
	{ range: [9, 10], effect: 'Roll 1d4. You grow that many inches taller.' }
	// ... more effects
];

// Surge Trigger Options
export const SURGE_TRIGGERS = {
	STANDARD: {
		name: 'Standard (PHB)',
		description:
			'Roll a d20 after casting a 1st level or higher spell. On a 1, roll on the Wild Magic table.',
		threshold: 1
	},
	ESCALATING: {
		name: 'Escalating',
		description:
			'Start with a threshold of 1. Each time you cast without a surge, increase the threshold by 1. Reset on surge.',
		threshold: 1,
		increment: 1
	},
	SPELL_LEVEL: {
		name: 'Spell Level',
		description:
			'Threshold equals the level of the spell cast. Cantrips count as 1.',
		useSpellLevel: true
	},
	CRITICAL: {
		name: 'Critical Surge',
		description: 'Surge on a natural 1 or 20 when casting a spell.',
		threshold: [1, 20]
	}
};
